  ...
  const makeRequest = async (
    ...
    //funktionen er async fordi det giver browseren mulighed for at køre functionen i bagrunden mens brugeren kigger på/bruger hjemmesiden
    {
      ...
      try {
        ...
        error //hvis der opstår en fejl kørrer vi denne kode for at vise det til brugeren og os selv
      ) {
        console.log("ERROR", error);
        setError("an error has ocurred: " + error.message);
        setData(null);
      } finally {
        //bliver kørt i slutningen uanset om vi har fået en fejl eller ej
        setIsLoading(false);
      }
    };
